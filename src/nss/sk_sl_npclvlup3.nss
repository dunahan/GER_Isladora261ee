...
void main()
{
  ...
  int nLvlFstCl = GetLevelByPosition(1, oSpeakTarg);        // Level der dritten Klasse auslesen
  int nLvlSndCl = GetLevelByPosition(2, oSpeakTarg);        // Level der dritten Klasse auslesen
  ...
  // Neue dritte Standardklasse hinzufügen
  if (nClNbr ==  0 && nSndClass !=  0 && nFstClass !=  0 && nTrdClass !=  0)
  { AdjustAlignment(oSpeakTarg, ALIGNMENT_NEUTRAL, 50, FALSE);
    ...
    LevelUpHenchman(oSpeakTarg, nTrdClass, FALSE, nPackage); }

  if (nClNbr ==  1 && nSndClass !=  1 && nFstClass !=  1 && nTrdClass !=  1)
  { AdjustAlignment(oSpeakTarg, ALIGNMENT_NEUTRAL, 50, FALSE);
    SendServerMessageToPC(oSpeaker, "Klasse Barde wird hinzugefügt. Gesinnung wurde angepasst.");
    LevelUpHenchman(oSpeakTarg, nTrdClass, FALSE, nPackage); }

  if (nClNbr ==  3 && nSndClass !=  3 && nFstClass !=  3 && nTrdClass !=  3)
  { AdjustAlignment(oSpeakTarg, ALIGNMENT_NEUTRAL, 50, FALSE);
    SendServerMessageToPC(oSpeaker, "Klasse Druide wird hinzugefügt. Gesinnung wurde angepasst.");
    LevelUpHenchman(oSpeakTarg, nTrdClass, FALSE, nPackage); }

  if (nClNbr ==  5 && nSndClass !=  5 && nFstClass !=  5 && nTrdClass !=  5)
  ...
  if (nClNbr ==  6 && nSndClass !=  6 && nFstClass !=  6 && nTrdClass !=  6)
  { AdjustAlignment(oSpeakTarg, ALIGNMENT_LAWFUL, 50, FALSE);
  ...
  if (nClNbr == 27 && nSndClass != 27 && nFstClass != 27 && nTrdClass != 27)
  ...
  if (nClNbr == 28 && nSndClass != 28 && nFstClass != 28 && nTrdClass != 28)
  ...
  if (nClNbr == 29 && nSndClass != 29 && nFstClass != 29 && nTrdClass != 29)
  { if ( (GetRacialType(oSpeakTarg) != 1) || (GetRacialType(oSpeakTarg) != 4) || // Rassenbeschränkungen prüfen!
         ...
         (nSndClass !=  9) || (nFstClass !=  9) || (nTrdClass !=  9) ||          // Klassenminimum Hexenmeister prüfen!
         (nSndClass != 10) || (nFstClass != 10) || (nTrdClass != 10) )           // Klassenminimum Magier prüfen!
  ...
  if (nClNbr == 30 && nSndClass != 30 && nFstClass != 30 && nTrdClass != 30)
  ...
  if (nClNbr == 31 && nSndClass != 31 && nFstClass != 31 && nTrdClass != 31)
  ...
  if (nClNbr == 32 && nSndClass != 32 && nFstClass != 32 && nTrdClass != 32)
  ...
  if (nClNbr == 33 && nSndClass != 33 && nFstClass != 33 && nTrdClass != 33)
  ...
  if (nClNbr == 34 && nSndClass != 34 && nFstClass != 34 && nTrdClass != 34)
  { if ( (nSndClass !=  9) || (nFstClass !=  9) || (nTrdClass !=  9) ||          // Klassenminimum Hexenmeister prüfen!
         (nSndClass != 10) || (nFstClass != 10) || (nTrdClass != 10) )           // Klassenminimum Magier prüfen!
    { SendServerMessageToPC(oSpeaker, "Diese Klasse ist nicht mit diesem NSC möglich."); return;}
    AdjustAlignment(oSpeakTarg, ALIGNMENT_EVIL, 50, FALSE);
    object oCreate = IPCreateProficiencyFeatItemOnCreature(oSpeakTarg);  ActionEquipItem(oCreate, 8); // Erschaffe Ring, der alle Talente gibt und rüste ihn aus
  ...
  if (nClNbr == 35 && nSndClass != 35 && nFstClass != 35 && nTrdClass != 35)
  { if ( (nSndClass !=  2) || (nFstClass !=  2) || (nTrdClass !=  2) ||          // Klassenminimum Kleriker prüfen!
         (nSndClass !=  3) || (nFstClass !=  3) || (nTrdClass !=  3) )           // Klassenminimum Druide prüfen!
    { SendServerMessageToPC(oSpeaker, "Diese Klasse ist nicht mit diesem NSC möglich."); return;}
    object oCreate = IPCreateProficiencyFeatItemOnCreature(oSpeakTarg);  ActionEquipItem(oCreate, 8); // Erschaffe Ring, der alle Talente gibt und rüste ihn aus
    if (GetIsObjectValid(GetItemInSlot(8, oSpeakTarg)) == TRUE) // ist der Ring existent?
    { itemproperty ipSkill = ItemPropertySkillBonus(255, 10);   // ja, dann lege die minimal Skills fest
  ...
  if (nClNbr == 36 && nSndClass != 36 && nFstClass != 36 && nTrdClass != 36)
  ...
  if (nClNbr == 37 && nSndClass != 37 && nFstClass != 37 && nTrdClass != 37)
  { if ( (nSndClass !=  1) || (nFstClass !=  1) || (nTrdClass !=  1) ||          // Klassenminimum Hexenmeister prüfen!
         (nSndClass !=  9) || (nFstClass !=  9) || (nTrdClass !=  9) )           // Klassenminimum Magier prüfen!
    { SendServerMessageToPC(oSpeaker, "Diese Klasse ist nicht mit diesem NSC möglich."); return;}
    object oCreate = IPCreateProficiencyFeatItemOnCreature(oSpeakTarg);  ActionEquipItem(oCreate, 8); // Erschaffe Ring, der alle Talente gibt und rüste ihn aus
    if (GetIsObjectValid(GetItemInSlot(8, oSpeakTarg)) == TRUE) // ist der Ring existent?
    { itemproperty ipSkill = ItemPropertySkillBonus(255, 10);   // ja, dann lege die minimal Skills fest
  ...
  if (nClNbr == 41 && nSndClass != 41 && nFstClass != 41 && nTrdClass != 41)
