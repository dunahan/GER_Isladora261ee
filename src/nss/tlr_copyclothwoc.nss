//::///////////////////////////////////////////////
//:: Tailor - Copy NPC Outfit TO PC w/o Cost!
//:: tlr_copyclothwoc.nss
...
//-- dunahan: changed to copy without costs!
//:://////////////////////////////////////////////
#include "_debugisla"
...
void main()
{
    ...
    if (!CompareAC(oNPCItem, oPCItem)) {
        SendServerMessageToPC(oPC, "Kopieren nicht möglich, Rüstungsklassen stimmen nicht überein!");
