...
void main()
{
  ...
  // CNR version string
  SetCustomToken(501, "V3.05 09Aug03 ger.");
  ...
  CnrAddCraftingDevice ("cnrHerbsBag");
  ...
  int bBuildRecipeDatabase = CnrGetPersistentInt(OBJECT_SELF, "CnrBoolBuildRecipeDatabase");    WriteTimestampedLogEntry("CnrBoolBuildRecipeDatabase: "+IntToString(bBuildRecipeDatabase));
