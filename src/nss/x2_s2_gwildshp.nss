...
void main()
{
    if ((MimicDisableNWNShape)&&GetIsPC(OBJECT_SELF))
    {
        SendServerMessageToPC(OBJECT_SELF, SHIFTER_NEWFORMS);
        return;
    }
    ...
    if (GetLocalString(oTarget,"CREATURE_RESREF")!="")
    {
        ResetAppearance(OBJECT_SELF);
    }
