...
/////////////////////////////////////////////////////////////////////////////
// Funktion um einen stillen Attributswurf durchzuführen
// Nichts wird dem Spieler mitgeteilt!
//
int GetIsAbilitySuccessfulPrivate(object oTarget, int nAbilityType, int nDifficulty)
{
  // 1.1 Wurf für die Fertigkeit anwenden
  if(GetAbilityScore(oTarget, nAbilityType) + d20() >= nDifficulty)
  {
    // 1.2.1 Da bestanden, teile Wahr mit
    return TRUE;
  }
