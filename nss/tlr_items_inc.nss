...
void RemakeCloak(object oNPC, object oItem, int nMode)
{
    ...
    if (GetIsObjectValid(oNew))
    {
        ...
        SendServerMessageToPC(oPC, "Neues Aussehen: " + IntToString(nCurrApp) +" "+ Get2DAString("cloakmodel", "LABEL", nCurrApp));
}
...
///////////////////////////////////////////////////////////////////
    ...
    if (GetIsObjectValid(oNew))
    {
        ...
        object oPC = GetPCSpeaker();
        SendServerMessageToPC(oPC, "Neues Aussehen: " + IntToString(nCurrApp));
}
...
void ColorItem(object oNPC, object oItem, int nPart, int nMode)
{
    ...
    if (GetIsObjectValid(oNew))
    {
        ...
        object oPC = GetPCSpeaker();
        SendServerMessageToPC(oPC, "Neue Farbe: " + IntToString(nCurrApp));
