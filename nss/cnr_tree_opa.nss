...
void main()
{
  ...
  if (GetIsObjectValid(oPC) && GetIsPC(oPC))
  {
    ...
    // Heal all damage that has been done
   int nCurHP = GetCurrentHitPoints(); int nToHea = nMaxHP - nCurHP;
   effect eHeal = EffectHeal(nToHea);
   ApplyEffectToObject(0, eHeal, OBJECT_SELF);
