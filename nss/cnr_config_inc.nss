...
void SendMsgToSpecialPC(string sPlayerAccount, string sMsg)
{
  object oPC = GetFirstPC();
  while (GetIsObjectValid(oPC))
  {
    if (GetPCPlayerName(oPC) == sPlayerAccount)
    {
...
// ore mining
float CNR_FLOAT_ORE_MINING_FIND_SECOND_NUGGET_PERCENTAGE = 45.0;
float CNR_FLOAT_ORE_MINING_FIND_MYSTERY_MINERAL_PERCENTAGE = 3.0;
float CNR_FLOAT_ORE_MINING_PICKAXE_BREAKAGE_PERCENTAGE = 0.0;
float CNR_FLOAT_ORE_MINING_DEPOSIT_BREAKAGE_PERCENTAGE = 0.0;
float CNR_FLOAT_ORE_MINING_DEPOSIT_RESPAWN_TIME_SECS = 3600.0; // 15 mins equal 900 real time

// forge operation
int   CNR_BOOL_FORGES_REQUIRE_COAL = FALSE;
float CNR_FLOAT_FORGE_COAL_BURN_TIME = 60.0f; // 1 min per nugget

// gem mining
float CNR_FLOAT_GEM_MINING_FIND_FIRST_MINERAL_PERCENTAGE = 45.0;
float CNR_FLOAT_GEM_MINING_FIND_SECOND_MINERAL_PERCENTAGE = 20.0;
float CNR_FLOAT_GEM_MINING_FIND_MYSTERY_MINERAL_PERCENTAGE = 3.0;
float CNR_FLOAT_GEM_MINING_CHISEL_BREAKAGE_PERCENTAGE = 0.0;
float CNR_FLOAT_GEM_MINING_DEPOSIT_BREAKAGE_PERCENTAGE = 0.0;
float CNR_FLOAT_GEM_MINING_DEPOSIT_RESPAWN_TIME_SECS = 3600.0; // 15 mins equal 900 real time

// misc mining deposit (dug with shovel, ie: clay & sand)
float CNR_FLOAT_MISC_MINING_DEPOSIT_CHANCE_OF_SUCCESS_PERCENTAGE = 65.0;
float CNR_FLOAT_MISC_MINING_DEPOSIT_SHOVEL_BREAKAGE_PERCENTAGE = 0.0;
float CNR_FLOAT_MISC_MINING_DEPOSIT_BREAKAGE_PERCENTAGE = 0.0;
float CNR_FLOAT_MISC_MINING_DEPOSIT_RESPAWN_TIME_SECS = 3600.0; // 15 mins equal 900 real time

// wood cutting
float CNR_FLOAT_WOOD_MINING_AXE_BREAKAGE_PERCENTAGE = 0.0;
float CNR_FLOAT_WOOD_MINING_TREE_BREAKAGE_PERCENTAGE = 0.0;
float CNR_FLOAT_WOOD_MINING_TREE_RESPAWN_TIME_SECS = 3600.0; // 15 mins equal 900 real time

// misc tool breakage
float CNR_FLOAT_SMITH_HAMMER_BREAKAGE_PERCENTAGE = 0.0;
float CNR_FLOAT_GEM_CRAFTERS_TOOLS_BREAKAGE_PERCENTAGE = 0.0;
float CNR_FLOAT_TINKERS_TOOLS_BREAKAGE_PERCENTAGE = 0.0;
float CNR_FLOAT_CARPS_TOOLS_BREAKAGE_PERCENTAGE = 0.0;
float CNR_FLOAT_SEWING_KIT_BREAKAGE_PERCENTAGE = 0.0;
...
float CNR_FLOAT_GAME_XP_SCALAR = 0.5;
