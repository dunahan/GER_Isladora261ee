...
void main()
{
    ...
    if(nUser == EVENT_HEARTBEAT) // OnHeartbeat Event
    {
        ...
        // Debug Stuff
        DebugMode("Current HPs = " + IntToString(nCurrentHPs)+"\n"+
                  "Subdual Damage = " + IntToString(nMaxHPsPossible - nCurrentHPs)+"\n"+
                  "Excess Damage = " + IntToString(nExcessDamage)+"\n"+
                  "Effective HPs = " + IntToString(nCurrentHPs - nExcessDamage)+"\n"+
                  "Max Possible HPs = " + IntToString(nMaxHPsPossible) + "/" + IntToString(nOriginalHPs)+"\n"+
                  "-----\n");
