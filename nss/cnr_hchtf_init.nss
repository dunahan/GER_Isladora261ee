...
void main()
{
  ...
  // Fruits 
  CnrSetPropertyString("cnrAppleFruit", "HCHTF_TAG", "Food_POOR"); 
  CnrSetPropertyString("cnrBlkberryFruit", "HCHTF_TAG", "Food_POOR"); 
  CnrSetPropertyString("cnrBluberryFruit", "HCHTF_TAG", "Food_POOR"); 
  CnrSetPropertyString("cnrCherryFruit", "HCHTF_TAG", "Food_POOR"); 
  CnrSetPropertyString("cnrCrnberryFruit", "HCHTF_TAG", "Food_POOR"); 
  CnrSetPropertyString("cnrEldberryFruit", "HCHTF_TAG", "Food_POOR"); 
  CnrSetPropertyString("cnrGrapeFruit", "HCHTF_TAG", "Food_POOR"); 
  CnrSetPropertyString("cnrJuniperFruit", "HCHTF_TAG", "Food_POOR"); 
  CnrSetPropertyString("cnrPearFruit", "HCHTF_TAG", "Food_POOR"); 
  CnrSetPropertyString("cnrRspberryFruit", "HCHTF_TAG", "Food_POOR"); 
  // Nuts 
  CnrSetPropertyString("cnrAlmondFruit", "HCHTF_TAG", "Food_POOR"); 
  CnrSetPropertyString("cnrChestnutFruit", "HCHTF_TAG", "Food_POOR"); 
  CnrSetPropertyString("cnrHazelnutFruit", "HCHTF_TAG", "Food_POOR"); 
  CnrSetPropertyString("cnrPecanFruit", "HCHTF_TAG", "Food_POOR"); 
  CnrSetPropertyString("cnrWalnutFruit", "HCHTF_TAG", "Food_POOR"); 
}
